...
export function ScoringPanel() {
  ...
  return (
    <aside
      className="w-[27rem] shrink-0 border-l border-black/5 glass overflow-y-auto h-full"
    >
      <div className="p-4 pb-8 space-y-5">
        ...
        {currentModel && (
          <>
            ...
            {!isFlowActive && !useEvalStore.getState().flowReviewScores && autoReport && (
              <button
        ...
        {/* Re-evaluate button (after flow completion, but results shown in header submit) */}
        {!isFlowActive && useEvalStore.getState().flowReviewScores && (
          <button
