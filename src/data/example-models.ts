...
const exampleModels: ExampleModelDef[] = [
  ...
  // ═══════════════════════════════════════════════════════
  {
    ...
    record: {
      ...
      maxTotal: 100,
      dimensionScores: [
        { dimensionId: 'face-quality', dimensionName: '面型质量', score: 4.8, maxScore: 15 },
        { dimensionId: 'face-errors', dimensionName: '面错误', score: 10, maxScore: 25 },
        { dimensionId: 'edge-flow', dimensionName: '布线合理性', score: 6, maxScore: 20 },
        { dimensionId: 'animation-friendly', dimensionName: '绑定动画友好性', score: 12, maxScore: 40 },
      ],
      autoReport: null,
      manualRatings: {},
      reviewScores: {
